...
cells = [
    ...
    # deps
    {
        ...
        "outputs": [],
        "source": [
            "# deps (no bitsandbytes: unused here; cmake/git are preinstalled on Kaggle)\n",
            "!pip install -q transformers datasets peft trl accelerate sentencepiece gguf protobuf || true\n",
            "!which cmake >/dev/null 2>&1 || (apt-get update -qq && apt-get install -y -qq cmake build-essential git) || true\n",
    ...
    # gguf code
    {
        ...
        "source": [
            ...
            "# Clean extra_special_tokens from tokenizer_config.json if it is a list (prevents transformers AttributeError)\n",
            "import json\n",
            "tok_cfg = os.path.join(MERGED_DIR, \"tokenizer_config.json\")\n",
            "if os.path.exists(tok_cfg):\n",
            "    with open(tok_cfg, \"r\") as _f:\n",
            "        _c = json.load(_f)\n",
            "    if \"extra_special_tokens\" in _c:\n",
            "        del _c[\"extra_special_tokens\"]\n",
            "        with open(tok_cfg, \"w\") as _f:\n",
            "            json.dump(_c, _f, indent=2)\n",
            "        print(\"sanitized tokenizer_config.json\")\n",
            "\n",
